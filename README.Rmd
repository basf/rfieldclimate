...
[![Codecov test coverage](https://codecov.io/gh/basf/rfieldclimate/branch/master/graph/badge.svg?token=3OZ8Y9VVWN)](https://codecov.io/gh/basf/rfieldclimate?branch=master)
<!-- badges: end -->
...
With `fc_request()` all the api functionality can be easily covered and we provide some wrapper around endpoints.
